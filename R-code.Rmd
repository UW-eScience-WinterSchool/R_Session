...
There are different ways to open files. Each requires a different function. In our case, we will open an **rds** file:
```{r}
...
This is the data frame you created in Python in the previous session. And you may have noticed the variable *Regime_type* has kept the **ordinal** conversion we did. If had saved that file in a different formar, you would have lost that change.
